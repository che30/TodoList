...
static ActivOnRefresh(){
  if (localStorage.getItem('selectedActiveId') === null) {
    selectedId = [0];
  } else {
    localStorage.setItem('selectedActiveId',JSON.stringify(UI.setSelected()));
  }
}
...
static countProject() {
 ...
 static synchro(argument) {
  ...
  console.log('here')
  console.log( JSON.parse(localStorage.getItem('selectedActiveId')))
